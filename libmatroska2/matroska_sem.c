...
const ebml_semantic EBML_SemanticSilentTracks[] = {
    {0, 0, &MATROSKA_ContextSilentTrackNumber, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_MATROSKA_V3|PROFILE_MATROSKA_V4|PROFILE_MATROSKA_V5|PROFILE_DIVX|PROFILE_WEBM},
    {0, 0, NULL ,0} // end of the table
};
...
const ebml_semantic EBML_SemanticTimeSlice[] = {
    {0, 1, &MATROSKA_ContextLaceNumber, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_MATROSKA_V3|PROFILE_MATROSKA_V4|PROFILE_MATROSKA_V5|PROFILE_DIVX|PROFILE_WEBM},
    {0, 1, &MATROSKA_ContextFrameNumber, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_MATROSKA_V3|PROFILE_MATROSKA_V4|PROFILE_MATROSKA_V5|PROFILE_DIVX|PROFILE_WEBM},
    {0, 1, &MATROSKA_ContextBlockAdditionID, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_MATROSKA_V3|PROFILE_MATROSKA_V4|PROFILE_MATROSKA_V5|PROFILE_DIVX|PROFILE_WEBM},
    {0, 1, &MATROSKA_ContextDelay, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_MATROSKA_V3|PROFILE_MATROSKA_V4|PROFILE_MATROSKA_V5|PROFILE_DIVX|PROFILE_WEBM},
    {0, 1, &MATROSKA_ContextSliceDuration, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_MATROSKA_V3|PROFILE_MATROSKA_V4|PROFILE_MATROSKA_V5|PROFILE_DIVX|PROFILE_WEBM},
    {0, 0, NULL ,0} // end of the table
};

const ebml_semantic EBML_SemanticSlices[] = {
    {0, 0, &MATROSKA_ContextTimeSlice, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_MATROSKA_V3|PROFILE_MATROSKA_V4|PROFILE_MATROSKA_V5|PROFILE_DIVX|PROFILE_WEBM},
    {0, 0, NULL ,0} // end of the table
};

const ebml_semantic EBML_SemanticReferenceFrame[] = {
    {1, 1, &MATROSKA_ContextReferenceOffset, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_MATROSKA_V3|PROFILE_MATROSKA_V4|PROFILE_MATROSKA_V5|PROFILE_WEBM},
    {1, 1, &MATROSKA_ContextReferenceTimestamp, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_MATROSKA_V3|PROFILE_MATROSKA_V4|PROFILE_MATROSKA_V5|PROFILE_WEBM},
    {0, 0, NULL ,0} // end of the table
};

const ebml_semantic EBML_SemanticBlockGroup[] = {
    {1, 1, &MATROSKA_ContextBlock, 0},
    {0, 1, &MATROSKA_ContextBlockVirtual, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_MATROSKA_V3|PROFILE_MATROSKA_V4|PROFILE_MATROSKA_V5|PROFILE_DIVX|PROFILE_WEBM},
    ...
    {0, 1, &MATROSKA_ContextReferenceVirtual, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_MATROSKA_V3|PROFILE_MATROSKA_V4|PROFILE_MATROSKA_V5|PROFILE_DIVX|PROFILE_WEBM},
    ...
    {0, 1, &MATROSKA_ContextSlices, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_MATROSKA_V3|PROFILE_MATROSKA_V4|PROFILE_MATROSKA_V5|PROFILE_DIVX|PROFILE_WEBM},
    {0, 1, &MATROSKA_ContextReferenceFrame, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_MATROSKA_V3|PROFILE_MATROSKA_V4|PROFILE_MATROSKA_V5|PROFILE_WEBM},
    {0, 0, NULL ,0} // end of the table
};

const ebml_semantic EBML_SemanticCluster[] = {
    {1, 1, &MATROSKA_ContextTimestamp, 0},
    {0, 1, &MATROSKA_ContextSilentTracks, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_MATROSKA_V3|PROFILE_MATROSKA_V4|PROFILE_MATROSKA_V5|PROFILE_DIVX|PROFILE_WEBM},
    {0, 1, &MATROSKA_ContextPosition, PROFILE_MATROSKA_V5|PROFILE_WEBM},
    {0, 1, &MATROSKA_ContextPrevSize, 0},
    {0, 0, &MATROSKA_ContextSimpleBlock, PROFILE_MATROSKA_V1},
    {0, 0, &MATROSKA_ContextBlockGroup, 0},
    {0, 0, &MATROSKA_ContextEncryptedBlock, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_MATROSKA_V3|PROFILE_MATROSKA_V4|PROFILE_MATROSKA_V5|PROFILE_DIVX|PROFILE_WEBM},
    {0, 0, NULL ,0} // end of the table
};
...
const ebml_semantic EBML_SemanticMasteringMetadata[] = {
    {0, 1, &MATROSKA_ContextPrimaryRChromaticityX, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_MATROSKA_V3|PROFILE_DIVX},
    {0, 1, &MATROSKA_ContextPrimaryRChromaticityY, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_MATROSKA_V3|PROFILE_DIVX},
    {0, 1, &MATROSKA_ContextPrimaryGChromaticityX, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_MATROSKA_V3|PROFILE_DIVX},
    {0, 1, &MATROSKA_ContextPrimaryGChromaticityY, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_MATROSKA_V3|PROFILE_DIVX},
    {0, 1, &MATROSKA_ContextPrimaryBChromaticityX, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_MATROSKA_V3|PROFILE_DIVX},
    {0, 1, &MATROSKA_ContextPrimaryBChromaticityY, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_MATROSKA_V3|PROFILE_DIVX},
    {0, 1, &MATROSKA_ContextWhitePointChromaticityX, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_MATROSKA_V3|PROFILE_DIVX},
    {0, 1, &MATROSKA_ContextWhitePointChromaticityY, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_MATROSKA_V3|PROFILE_DIVX},
    {0, 1, &MATROSKA_ContextLuminanceMax, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_MATROSKA_V3|PROFILE_DIVX},
    {0, 1, &MATROSKA_ContextLuminanceMin, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_MATROSKA_V3|PROFILE_DIVX},
    {0, 0, NULL ,0} // end of the table
};

const ebml_semantic EBML_SemanticColour[] = {
    {1, 1, &MATROSKA_ContextMatrixCoefficients, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_MATROSKA_V3|PROFILE_DIVX},
    {1, 1, &MATROSKA_ContextBitsPerChannel, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_MATROSKA_V3|PROFILE_DIVX},
    {0, 1, &MATROSKA_ContextChromaSubsamplingHorz, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_MATROSKA_V3|PROFILE_DIVX},
    {0, 1, &MATROSKA_ContextChromaSubsamplingVert, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_MATROSKA_V3|PROFILE_DIVX},
    {0, 1, &MATROSKA_ContextCbSubsamplingHorz, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_MATROSKA_V3|PROFILE_DIVX},
    {0, 1, &MATROSKA_ContextCbSubsamplingVert, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_MATROSKA_V3|PROFILE_DIVX},
    {1, 1, &MATROSKA_ContextChromaSitingHorz, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_MATROSKA_V3|PROFILE_DIVX},
    {1, 1, &MATROSKA_ContextChromaSitingVert, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_MATROSKA_V3|PROFILE_DIVX},
    {1, 1, &MATROSKA_ContextRange, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_MATROSKA_V3|PROFILE_DIVX},
    {1, 1, &MATROSKA_ContextTransferCharacteristics, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_MATROSKA_V3|PROFILE_DIVX},
    {1, 1, &MATROSKA_ContextPrimaries, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_MATROSKA_V3|PROFILE_DIVX},
    {0, 1, &MATROSKA_ContextMaxCLL, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_MATROSKA_V3|PROFILE_DIVX},
    {0, 1, &MATROSKA_ContextMaxFALL, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_MATROSKA_V3|PROFILE_DIVX},
    {0, 1, &MATROSKA_ContextMasteringMetadata, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_MATROSKA_V3|PROFILE_DIVX},
    {0, 0, NULL ,0} // end of the table
};
...
const ebml_semantic EBML_SemanticVideo[] = {
    ...
    {1, 1, &MATROSKA_ContextStereoMode, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_DIVX},
    {1, 1, &MATROSKA_ContextAlphaMode, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_DIVX},
    {0, 1, &MATROSKA_ContextOldStereoMode, PROFILE_MATROSKA_V3|PROFILE_MATROSKA_V4|PROFILE_MATROSKA_V5|PROFILE_WEBM},
    {1, 1, &MATROSKA_ContextPixelWidth, 0},
    {1, 1, &MATROSKA_ContextPixelHeight, 0},
    {1, 1, &MATROSKA_ContextPixelCropBottom, 0},
    {1, 1, &MATROSKA_ContextPixelCropTop, 0},
    {1, 1, &MATROSKA_ContextPixelCropLeft, 0},
    {1, 1, &MATROSKA_ContextPixelCropRight, 0},
    {0, 1, &MATROSKA_ContextDisplayWidth, 0},
    {0, 1, &MATROSKA_ContextDisplayHeight, 0},
    {1, 1, &MATROSKA_ContextDisplayUnit, 0},
    {0, 1, &MATROSKA_ContextAspectRatioType, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_MATROSKA_V3|PROFILE_MATROSKA_V4|PROFILE_MATROSKA_V5|PROFILE_DIVX|PROFILE_WEBM},
    {0, 1, &MATROSKA_ContextUncompressedFourCC, PROFILE_WEBM},
    {0, 1, &MATROSKA_ContextGammaValue, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_MATROSKA_V3|PROFILE_MATROSKA_V4|PROFILE_MATROSKA_V5|PROFILE_DIVX|PROFILE_WEBM},
    {0, 1, &MATROSKA_ContextFrameRate, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_MATROSKA_V3|PROFILE_MATROSKA_V4|PROFILE_MATROSKA_V5|PROFILE_DIVX|PROFILE_WEBM},
    {0, 1, &MATROSKA_ContextColour, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_MATROSKA_V3|PROFILE_DIVX},
...
const ebml_semantic EBML_SemanticContentEncryption[] = {
    ...
    {0, 1, &MATROSKA_ContextContentSignature, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_MATROSKA_V3|PROFILE_MATROSKA_V4|PROFILE_MATROSKA_V5|PROFILE_DIVX|PROFILE_WEBM},
    {0, 1, &MATROSKA_ContextContentSigKeyID, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_MATROSKA_V3|PROFILE_MATROSKA_V4|PROFILE_MATROSKA_V5|PROFILE_DIVX|PROFILE_WEBM},
    {0, 1, &MATROSKA_ContextContentSigAlgo, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_MATROSKA_V3|PROFILE_MATROSKA_V4|PROFILE_MATROSKA_V5|PROFILE_DIVX|PROFILE_WEBM},
    {0, 1, &MATROSKA_ContextContentSigHashAlgo, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_MATROSKA_V3|PROFILE_MATROSKA_V4|PROFILE_MATROSKA_V5|PROFILE_DIVX|PROFILE_WEBM},
    {0, 0, NULL ,0} // end of the table
};
...
const ebml_semantic EBML_SemanticTrackEntry[] = {
    ...
    {0, 1, &MATROSKA_ContextFlagHearingImpaired, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_MATROSKA_V3|PROFILE_DIVX|PROFILE_WEBM},
    {0, 1, &MATROSKA_ContextFlagVisualImpaired, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_MATROSKA_V3|PROFILE_DIVX|PROFILE_WEBM},
    {0, 1, &MATROSKA_ContextFlagTextDescriptions, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_MATROSKA_V3|PROFILE_DIVX|PROFILE_WEBM},
    {0, 1, &MATROSKA_ContextFlagOriginal, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_MATROSKA_V3|PROFILE_DIVX|PROFILE_WEBM},
    {0, 1, &MATROSKA_ContextFlagCommentary, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_MATROSKA_V3|PROFILE_DIVX|PROFILE_WEBM},
    {1, 1, &MATROSKA_ContextFlagLacing, 0},
    {1, 1, &MATROSKA_ContextMinCache, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_MATROSKA_V3|PROFILE_MATROSKA_V4|PROFILE_MATROSKA_V5|PROFILE_DIVX|PROFILE_WEBM},
    {0, 1, &MATROSKA_ContextMaxCache, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_MATROSKA_V3|PROFILE_MATROSKA_V4|PROFILE_MATROSKA_V5|PROFILE_DIVX|PROFILE_WEBM},
    ...
    {1, 1, &MATROSKA_ContextTrackTimestampScale, PROFILE_MATROSKA_V4|PROFILE_MATROSKA_V5|PROFILE_WEBM},
    {0, 1, &MATROSKA_ContextTrackOffset, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_MATROSKA_V3|PROFILE_MATROSKA_V4|PROFILE_MATROSKA_V5|PROFILE_DIVX|PROFILE_WEBM},
    ...
    {0, 1, &MATROSKA_ContextAttachmentLink, PROFILE_MATROSKA_V4|PROFILE_MATROSKA_V5|PROFILE_WEBM},
    {0, 1, &MATROSKA_ContextCodecSettings, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_MATROSKA_V3|PROFILE_MATROSKA_V4|PROFILE_MATROSKA_V5|PROFILE_DIVX|PROFILE_WEBM},
    {0, 0, &MATROSKA_ContextCodecInfoURL, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_MATROSKA_V3|PROFILE_MATROSKA_V4|PROFILE_MATROSKA_V5|PROFILE_DIVX|PROFILE_WEBM},
    {0, 0, &MATROSKA_ContextCodecDownloadURL, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_MATROSKA_V3|PROFILE_MATROSKA_V4|PROFILE_MATROSKA_V5|PROFILE_DIVX|PROFILE_WEBM},
    {1, 1, &MATROSKA_ContextCodecDecodeAll, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_MATROSKA_V3|PROFILE_MATROSKA_V4|PROFILE_MATROSKA_V5|PROFILE_DIVX|PROFILE_WEBM},
    {0, 0, &MATROSKA_ContextTrackOverlay, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_MATROSKA_V3|PROFILE_MATROSKA_V4|PROFILE_MATROSKA_V5|PROFILE_DIVX|PROFILE_WEBM},
    {1, 1, &MATROSKA_ContextCodecDelay, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_MATROSKA_V3|PROFILE_DIVX},
    ...
    {0, 1, &MATROSKA_ContextTrickTrackUID, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_MATROSKA_V3|PROFILE_MATROSKA_V4|PROFILE_MATROSKA_V5|PROFILE_WEBM},
    {0, 1, &MATROSKA_ContextTrickTrackSegmentUID, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_MATROSKA_V3|PROFILE_MATROSKA_V4|PROFILE_MATROSKA_V5|PROFILE_WEBM},
    {0, 1, &MATROSKA_ContextTrickTrackFlag, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_MATROSKA_V3|PROFILE_MATROSKA_V4|PROFILE_MATROSKA_V5|PROFILE_WEBM},
    {0, 1, &MATROSKA_ContextTrickMasterTrackUID, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_MATROSKA_V3|PROFILE_MATROSKA_V4|PROFILE_MATROSKA_V5|PROFILE_WEBM},
    {0, 1, &MATROSKA_ContextTrickMasterTrackSegmentUID, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_MATROSKA_V3|PROFILE_MATROSKA_V4|PROFILE_MATROSKA_V5|PROFILE_WEBM},
...
const ebml_semantic EBML_SemanticCueReference[] = {
    ...
    {1, 1, &MATROSKA_ContextCueRefCluster, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_MATROSKA_V3|PROFILE_MATROSKA_V4|PROFILE_MATROSKA_V5|PROFILE_DIVX|PROFILE_WEBM},
    {0, 1, &MATROSKA_ContextCueRefNumber, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_MATROSKA_V3|PROFILE_MATROSKA_V4|PROFILE_MATROSKA_V5|PROFILE_DIVX|PROFILE_WEBM},
    {0, 1, &MATROSKA_ContextCueRefCodecState, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_MATROSKA_V3|PROFILE_MATROSKA_V4|PROFILE_MATROSKA_V5|PROFILE_DIVX|PROFILE_WEBM},
    {0, 0, NULL ,0} // end of the table
};
...
const ebml_semantic EBML_SemanticCueTrackPositions[] = {
    ...
    {1, 1, &MATROSKA_ContextCueCodecState, PROFILE_MATROSKA_V1|PROFILE_DIVX|PROFILE_WEBM},
...
const ebml_semantic EBML_SemanticAttachedFile[] = {
    ...
    {0, 1, &MATROSKA_ContextFileReferral, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_MATROSKA_V3|PROFILE_MATROSKA_V4|PROFILE_MATROSKA_V5|PROFILE_DIVX|PROFILE_WEBM},
    {0, 1, &MATROSKA_ContextFileUsedStartTime, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_MATROSKA_V3|PROFILE_MATROSKA_V4|PROFILE_MATROSKA_V5|PROFILE_WEBM},
    {0, 1, &MATROSKA_ContextFileUsedEndTime, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_MATROSKA_V3|PROFILE_MATROSKA_V4|PROFILE_MATROSKA_V5|PROFILE_WEBM},
    {0, 0, NULL ,0} // end of the table
};
...
const ebml_semantic EBML_SemanticChapterAtom[] = {
    ...
    {0, 1, &MATROSKA_ContextChapterSkipType, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_MATROSKA_V3|PROFILE_MATROSKA_V4|PROFILE_DIVX|PROFILE_WEBM},
...
const ebml_semantic EBML_SemanticTargets[] = {
    {1, 1, &MATROSKA_ContextTargetTypeValue, 0},
...
const ebml_semantic EBML_SemanticSimpleTag[] = {
    ...
    {1, 1, &MATROSKA_ContextTagDefaultBogus, PROFILE_MATROSKA_V1|PROFILE_MATROSKA_V2|PROFILE_MATROSKA_V3|PROFILE_MATROSKA_V4|PROFILE_MATROSKA_V5|PROFILE_DIVX|PROFILE_WEBM},
...
void MATROSKA_InitSemantic(void)
{
    ...
    MATROSKA_ContextTimestampScale = (ebml_context) {0x2AD7B1, EBML_INTEGER_CLASS, 1, (intptr_t)1000000, "TimestampScale", NULL, EBML_getSemanticGlobals()};
    ...
    MATROSKA_ContextBlockAddID = (ebml_context) {0xEE, EBML_INTEGER_CLASS, 1, (intptr_t)1, "BlockAddID", NULL, EBML_getSemanticGlobals()};
    ...
    MATROSKA_ContextReferencePriority = (ebml_context) {0xFA, EBML_INTEGER_CLASS, 1, (intptr_t)0, "ReferencePriority", NULL, EBML_getSemanticGlobals()};
    ...
    MATROSKA_ContextFrameNumber = (ebml_context) {0xCD, EBML_INTEGER_CLASS, 1, (intptr_t)0, "FrameNumber", NULL, EBML_getSemanticGlobals()};
    MATROSKA_ContextBlockAdditionID = (ebml_context) {0xCB, EBML_INTEGER_CLASS, 1, (intptr_t)0, "BlockAdditionID", NULL, EBML_getSemanticGlobals()};
    MATROSKA_ContextDelay = (ebml_context) {0xCE, EBML_INTEGER_CLASS, 1, (intptr_t)0, "Delay", NULL, EBML_getSemanticGlobals()};
    MATROSKA_ContextSliceDuration = (ebml_context) {0xCF, EBML_INTEGER_CLASS, 1, (intptr_t)0, "SliceDuration", NULL, EBML_getSemanticGlobals()};
    ...
    MATROSKA_ContextFlagEnabled = (ebml_context) {0xB9, EBML_BOOLEAN_CLASS, 1, (intptr_t)1, "FlagEnabled", NULL, EBML_getSemanticGlobals()};
    MATROSKA_ContextFlagDefault = (ebml_context) {0x88, EBML_BOOLEAN_CLASS, 1, (intptr_t)1, "FlagDefault", NULL, EBML_getSemanticGlobals()};
    MATROSKA_ContextFlagForced = (ebml_context) {0x55AA, EBML_BOOLEAN_CLASS, 1, (intptr_t)0, "FlagForced", NULL, EBML_getSemanticGlobals()};
    ...
    MATROSKA_ContextFlagLacing = (ebml_context) {0x9C, EBML_BOOLEAN_CLASS, 1, (intptr_t)1, "FlagLacing", NULL, EBML_getSemanticGlobals()};
    MATROSKA_ContextMinCache = (ebml_context) {0x6DE7, EBML_INTEGER_CLASS, 1, (intptr_t)0, "MinCache", NULL, EBML_getSemanticGlobals()};
    ...
    MATROSKA_ContextBlockAddIDType = (ebml_context) {0x41E7, EBML_INTEGER_CLASS, 1, (intptr_t)0, "BlockAddIDType", NULL, EBML_getSemanticGlobals()};
    ...
    MATROSKA_ContextCodecDecodeAll = (ebml_context) {0xAA, EBML_BOOLEAN_CLASS, 1, (intptr_t)1, "CodecDecodeAll", NULL, EBML_getSemanticGlobals()};
    MATROSKA_ContextTrackOverlay = (ebml_context) {0x6FAB, EBML_INTEGER_CLASS, 0, 0, "TrackOverlay", NULL, EBML_getSemanticGlobals()};
    MATROSKA_ContextCodecDelay = (ebml_context) {0x56AA, EBML_INTEGER_CLASS, 1, (intptr_t)0, "CodecDelay", NULL, EBML_getSemanticGlobals()};
    MATROSKA_ContextSeekPreRoll = (ebml_context) {0x56BB, EBML_INTEGER_CLASS, 1, (intptr_t)0, "SeekPreRoll", NULL, EBML_getSemanticGlobals()};
    ...
    MATROSKA_ContextFlagInterlaced = (ebml_context) {0x9A, EBML_INTEGER_CLASS, 1, (intptr_t)0, "FlagInterlaced", NULL, EBML_getSemanticGlobals()};
    MATROSKA_ContextFieldOrder = (ebml_context) {0x9D, EBML_INTEGER_CLASS, 1, (intptr_t)2, "FieldOrder", NULL, EBML_getSemanticGlobals()};
    MATROSKA_ContextStereoMode = (ebml_context) {0x53B8, EBML_INTEGER_CLASS, 1, (intptr_t)0, "StereoMode", NULL, EBML_getSemanticGlobals()};
    MATROSKA_ContextAlphaMode = (ebml_context) {0x53C0, EBML_INTEGER_CLASS, 1, (intptr_t)0, "AlphaMode", NULL, EBML_getSemanticGlobals()};
    ...
    MATROSKA_ContextPixelCropBottom = (ebml_context) {0x54AA, EBML_INTEGER_CLASS, 1, (intptr_t)0, "PixelCropBottom", NULL, EBML_getSemanticGlobals()};
    MATROSKA_ContextPixelCropTop = (ebml_context) {0x54BB, EBML_INTEGER_CLASS, 1, (intptr_t)0, "PixelCropTop", NULL, EBML_getSemanticGlobals()};
    MATROSKA_ContextPixelCropLeft = (ebml_context) {0x54CC, EBML_INTEGER_CLASS, 1, (intptr_t)0, "PixelCropLeft", NULL, EBML_getSemanticGlobals()};
    MATROSKA_ContextPixelCropRight = (ebml_context) {0x54DD, EBML_INTEGER_CLASS, 1, (intptr_t)0, "PixelCropRight", NULL, EBML_getSemanticGlobals()};
    ...
    MATROSKA_ContextDisplayUnit = (ebml_context) {0x54B2, EBML_INTEGER_CLASS, 1, (intptr_t)0, "DisplayUnit", NULL, EBML_getSemanticGlobals()};
    MATROSKA_ContextAspectRatioType = (ebml_context) {0x54B3, EBML_INTEGER_CLASS, 1, (intptr_t)0, "AspectRatioType", NULL, EBML_getSemanticGlobals()};
    ...
    MATROSKA_ContextMatrixCoefficients = (ebml_context) {0x55B1, EBML_INTEGER_CLASS, 1, (intptr_t)2, "MatrixCoefficients", NULL, EBML_getSemanticGlobals()};
    MATROSKA_ContextBitsPerChannel = (ebml_context) {0x55B2, EBML_INTEGER_CLASS, 1, (intptr_t)0, "BitsPerChannel", NULL, EBML_getSemanticGlobals()};
    ...
    MATROSKA_ContextChromaSitingHorz = (ebml_context) {0x55B7, EBML_INTEGER_CLASS, 1, (intptr_t)0, "ChromaSitingHorz", NULL, EBML_getSemanticGlobals()};
    MATROSKA_ContextChromaSitingVert = (ebml_context) {0x55B8, EBML_INTEGER_CLASS, 1, (intptr_t)0, "ChromaSitingVert", NULL, EBML_getSemanticGlobals()};
    MATROSKA_ContextRange = (ebml_context) {0x55B9, EBML_INTEGER_CLASS, 1, (intptr_t)0, "Range", NULL, EBML_getSemanticGlobals()};
    MATROSKA_ContextTransferCharacteristics = (ebml_context) {0x55BA, EBML_INTEGER_CLASS, 1, (intptr_t)2, "TransferCharacteristics", NULL, EBML_getSemanticGlobals()};
    MATROSKA_ContextPrimaries = (ebml_context) {0x55BB, EBML_INTEGER_CLASS, 1, (intptr_t)2, "Primaries", NULL, EBML_getSemanticGlobals()};
    ...
    MATROSKA_ContextEmphasis = (ebml_context) {0x52F1, EBML_INTEGER_CLASS, 1, (intptr_t)0, "Emphasis", NULL, EBML_getSemanticGlobals()};
    ...
    MATROSKA_ContextTrickTrackFlag = (ebml_context) {0xC6, EBML_INTEGER_CLASS, 1, (intptr_t)0, "TrickTrackFlag", NULL, EBML_getSemanticGlobals()};
    ...
    MATROSKA_ContextContentEncodingOrder = (ebml_context) {0x5031, EBML_INTEGER_CLASS, 1, (intptr_t)0, "ContentEncodingOrder", NULL, EBML_getSemanticGlobals()};
    MATROSKA_ContextContentEncodingScope = (ebml_context) {0x5032, EBML_INTEGER_CLASS, 1, (intptr_t)1, "ContentEncodingScope", NULL, EBML_getSemanticGlobals()};
    MATROSKA_ContextContentEncodingType = (ebml_context) {0x5033, EBML_INTEGER_CLASS, 1, (intptr_t)0, "ContentEncodingType", NULL, EBML_getSemanticGlobals()};
    MATROSKA_ContextContentCompAlgo = (ebml_context) {0x4254, EBML_INTEGER_CLASS, 1, (intptr_t)0, "ContentCompAlgo", NULL, EBML_getSemanticGlobals()};
    ...
    MATROSKA_ContextContentEncAlgo = (ebml_context) {0x47E1, EBML_INTEGER_CLASS, 1, (intptr_t)0, "ContentEncAlgo", NULL, EBML_getSemanticGlobals()};
    ...
    MATROSKA_ContextContentSigAlgo = (ebml_context) {0x47E5, EBML_INTEGER_CLASS, 1, (intptr_t)0, "ContentSigAlgo", NULL, EBML_getSemanticGlobals()};
    MATROSKA_ContextContentSigHashAlgo = (ebml_context) {0x47E6, EBML_INTEGER_CLASS, 1, (intptr_t)0, "ContentSigHashAlgo", NULL, EBML_getSemanticGlobals()};
    ...
    MATROSKA_ContextCueCodecState = (ebml_context) {0xEA, EBML_INTEGER_CLASS, 1, (intptr_t)0, "CueCodecState", NULL, EBML_getSemanticGlobals()};
    ...
    MATROSKA_ContextCueRefNumber = (ebml_context) {0x535F, EBML_INTEGER_CLASS, 1, (intptr_t)1, "CueRefNumber", NULL, EBML_getSemanticGlobals()};
    MATROSKA_ContextCueRefCodecState = (ebml_context) {0xEB, EBML_INTEGER_CLASS, 1, (intptr_t)0, "CueRefCodecState", NULL, EBML_getSemanticGlobals()};
    ...
    MATROSKA_ContextEditionFlagHidden = (ebml_context) {0x45BD, EBML_BOOLEAN_CLASS, 1, (intptr_t)0, "EditionFlagHidden", NULL, EBML_getSemanticGlobals()};
    MATROSKA_ContextEditionFlagDefault = (ebml_context) {0x45DB, EBML_BOOLEAN_CLASS, 1, (intptr_t)0, "EditionFlagDefault", NULL, EBML_getSemanticGlobals()};
    MATROSKA_ContextEditionFlagOrdered = (ebml_context) {0x45DD, EBML_BOOLEAN_CLASS, 1, (intptr_t)0, "EditionFlagOrdered", NULL, EBML_getSemanticGlobals()};
    ...
    MATROSKA_ContextChapterFlagHidden = (ebml_context) {0x98, EBML_BOOLEAN_CLASS, 1, (intptr_t)0, "ChapterFlagHidden", NULL, EBML_getSemanticGlobals()};
    MATROSKA_ContextChapterFlagEnabled = (ebml_context) {0x4598, EBML_BOOLEAN_CLASS, 1, (intptr_t)1, "ChapterFlagEnabled", NULL, EBML_getSemanticGlobals()};
    ...
    MATROSKA_ContextChapProcessCodecID = (ebml_context) {0x6955, EBML_INTEGER_CLASS, 1, (intptr_t)0, "ChapProcessCodecID", NULL, EBML_getSemanticGlobals()};
    ...
    MATROSKA_ContextTargetTypeValue = (ebml_context) {0x68CA, EBML_INTEGER_CLASS, 1, (intptr_t)50, "TargetTypeValue", NULL, EBML_getSemanticGlobals()};
    MATROSKA_ContextTargetType = (ebml_context) {0x63CA, EBML_STRING_CLASS, 0, 0, "TargetType", NULL, EBML_getSemanticGlobals()};
    MATROSKA_ContextTagTrackUID = (ebml_context) {0x63C5, EBML_INTEGER_CLASS, 1, (intptr_t)0, "TagTrackUID", NULL, EBML_getSemanticGlobals()};
    MATROSKA_ContextTagEditionUID = (ebml_context) {0x63C9, EBML_INTEGER_CLASS, 1, (intptr_t)0, "TagEditionUID", NULL, EBML_getSemanticGlobals()};
    MATROSKA_ContextTagChapterUID = (ebml_context) {0x63C4, EBML_INTEGER_CLASS, 1, (intptr_t)0, "TagChapterUID", NULL, EBML_getSemanticGlobals()};
    MATROSKA_ContextTagAttachmentUID = (ebml_context) {0x63C6, EBML_INTEGER_CLASS, 1, (intptr_t)0, "TagAttachmentUID", NULL, EBML_getSemanticGlobals()};
    ...
    MATROSKA_ContextTagDefault = (ebml_context) {0x4484, EBML_BOOLEAN_CLASS, 1, (intptr_t)1, "TagDefault", NULL, EBML_getSemanticGlobals()};
    MATROSKA_ContextTagDefaultBogus = (ebml_context) {0x44B4, EBML_BOOLEAN_CLASS, 1, (intptr_t)1, "TagDefaultBogus", NULL, EBML_getSemanticGlobals()};
